<template>
    <div class="row"  style=" width: 873px; ">
      ...
      <div class="col-md-10" v-if="allMessage.user">
        <div class="card">
          <div class="card-header text-center myrow">
            <strong> Selected {{ allMessage.user.name }} </strong>
          </div>
          <div class="card-body chat-msg">
            <ul class="chat" v-for="(msg,index) in allMessage.message" :key="index">
  
             <li class="sender clearfix" v-if="allMessage.user.id === msg.sender_id">

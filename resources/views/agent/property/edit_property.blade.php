    ...
    <div class="row profile-body">
        ...
        <div class="col-md-12 col-xl-12 middle-wrapper">
            <div class="row">
                <div class="card">
                    <div class="card-body">
                        <h6 class="card-title">Edit Agent Property</h6>
                            <form method="post" action="{{ route('update.agent.property') }}" id="myForm" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="js-example-basic-multiple form-select" multiple="multiple" data-width="100%" name="amenities_id[]" required>
                                                ...
                                                <option value="{{ $amenity->amenities_name }}" {{ (in_array($amenity->amenities_name,$property_aminity)) ? 'selected' : '' }}>{{ $amenity->amenities_name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div><!-- Col -->
                ...
                <div class="card">
                    <div class="card-body">
                        <h6 class="card-title">Edit Main Thumbnail Image</h6>
                            <form method="post" action="{{ route('update.agent.property.thumbnail') }}" id="myForm" enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" name="id" value="{{ $property->id }}">
                ...
                <div class="card">
                    <div class="card-body">
                        <h6 class="card-title">Edit Multi Image</h6>
                            <form method="post" action="{{ route('update.agent.property.multiimage') }}" id="myForm" enctype="multipart/form-data">
                                @csrf
										...
										<tbody>
                                            ...
                                            <tr>
												...
												<td>
                                                    ...
                                                    <a href="{{ route('delete.agent.property.multiimage',$img->id) }}" class="btn btn-danger" id="delete">Delete</a>
                                                </td>
											</tr>
                                            @endforeach

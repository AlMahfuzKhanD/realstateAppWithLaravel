        ...
        <section class="property-details property-details-one">
            <div class="auto-container">
                    ...
                    <div class="right-column pull-right clearfix">
                        <div class="price-inner clearfix">
                            ...
                            <div class="price-box pull-right">
                                <h3>${{ $property->lowest_price??'' }}.00</h3>
                            </div>
                        </div>
                        ...
                        <div class="property-details-content">
                            ...
                            <div class="location-box content-widget">
                                ...
                                <div class="google-map-area">
                                    <div 
                                        ...
                                        data-map-lat="{{ $property->latitude??40.712776 }}" 
                                        data-map-lng="{{ $property->longitude?? -74.005974}}" 
                                        ...
                                        <div class="inner">
                                            ...
                                            <div class="box clearfix">
                                                <div class="text pull-left">
                                                    <h6>{{ $facility->facility_name??'' }} <span>({{ $facility->distance??0 }} km)</span></h6>
                                                </div>
                            ...
                            <div class="statistics-box content-widget">
                                ...
                                <figure class="image-box">
                                    <iframe width="700" height="400" src="https://www.youtube.com/embed/4jnzf1yj48M?si=sjeOy7aW-hO43tIa" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                                </figure>
                            </div>
                ...
                <div class="similar-content">
                    ...
                    <div class="row clearfix">
                        @foreach ($similer_property as $item)

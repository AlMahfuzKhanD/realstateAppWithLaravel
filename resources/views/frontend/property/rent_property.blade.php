                            ...
                            <div class="widget-content">
                                ...
                                <div class="select-box">
                                    <select name="ptype_id" class="wide">
                                        <option data-display="Select Type" selected="" disabled="">Select Location</option>
                                ...
                                <div class="select-box">
                                    <select name="bedrooms" class="wide">
                                        <option data-display="Max Rooms" selected="" disabled="">Max Rooms</option>
                                ...
                                <div class="select-box">
                                    <select name="bathrooms" class="wide">
                                        <option data-display="Max Bath Rooms" selected="" disabled="">Max Bath Rooms</option>
            ...
            <div class="col-lg-8 col-md-12 col-sm-12 content-side">
                <div class="property-content-side">
                                            ...
                                            <div class="deals-block-one">
                                                <div class="inner-box">
                                                    <div class="image-box">
                                                        ...
                                                        <div class="buy-btn"><a href="{{ $item->property_status == 'rent' ?  route('rent.property') : route('buy.property')  }}">For {{ $item->property_status??'' }}</a></div>
                                                    </div>
                    ...
                    <div class="pagination-wrapper">
                        {{ $property->links('vendor.pagination.custom_pagination') }}
                    </div>
                </div>
            </div>
        </div>
